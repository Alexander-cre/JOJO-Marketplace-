...
const Cart = () => {
    ...
    const history = useRouter(); // or use Next.js router
    ...
    const componentProps = {
        ...
        onSuccess: (reference) => {
            ...
            history.push(`/success?trxref=${reference.trxref}&reference=${reference.reference}&status=${reference.status}&trans=${reference.trans}`);
        },
        onClose: () => {
