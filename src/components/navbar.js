    ...
    return (
        <header className='shadow-lg font-[sans-serif] tracking-wide relative z-50'>
            <section
                ...
                <a href="/" class="hidden max-sm:block"><img src="" alt="logo" class='w-9' />
                </a>
            ...
            {isMenuOpen && (
                <div className='lg:hidden fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 z-50'>
                    <div className='bg-white p-6'>
                        <button onClick={handleToggleMenu} className='absolute top-2 right-2'>
                        ...
                        <ul className='flex flex-col space-y-4'>
                            <li><Link href='/new' className='hover:text-yellow-300'>New</Link></li>
                            <li><Link href='/brands' className='hover:text-yellow-300'>Brands</Link></li>
                            <li><Link href='/makeup' className='hover:text-yellow-300'>Makeup</Link></li>
                            <li><Link href='/hair' className='hover:text-yellow-300'>Hair</Link></li>
                            <li><Link href='/tools' className='hover:text-yellow-300'>Tools & Brushes</Link></li>
                            <li><Link href='/bath' className='hover:text-yellow-300'>Bath & Body</Link></li>
                            <li><Link href='/gifts' className='hover:text-yellow-300'>Gifts</Link></li>
                            <li><Link href='/skincare' className='hover:text-yellow-300'>Skincare</Link></li>
                        </ul>
                    </div>
                </div>
            )}
